...
//string
let cadena: string = "julian";

//number
let numero: number = 12;

//boolean
let verdader_false:boolean = true;
...
let cadena_multiple: string | number = "julian";
...
//--------------------------------------------------------------------------------//
//nuevos tuois de datos personalizados
//------------------------------------------------------------------------------//
//se usa type para especificar que se va a crear un nuevo tipo de dato personalizado
type alfanumerico = string | number;

let nuevotipodato:alfanumerico = "datopersonalizado";
